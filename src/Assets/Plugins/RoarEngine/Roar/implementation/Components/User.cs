...
//			Hashtable args = new Hashtable ();
//			args ["code"] = code;
//			userActions.fetch_facebook_oauth(args, new FetchFacebookOAuthTokenCallback (cb, this));
//		}
//
//
...
//            protected User user;
//
//            public FetchFacebookOAuthTokenCallback(Roar.Callback in_cb, User in_user)
//                : base(in_cb)
//            {
//                user = in_user;
//            }
